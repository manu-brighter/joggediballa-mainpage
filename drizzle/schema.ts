import { int, mysqlEnum, mysqlTable, text, timestamp, varchar, boolean, bigint, unique, date, index } from "drizzle-orm/mysql-core";
...
export const events = mysqlTable("events", {
  ...
  eventUrl: text("eventUrl"), // Optional: Link to external event page
